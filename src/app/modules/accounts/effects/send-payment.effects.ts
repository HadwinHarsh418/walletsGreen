...
import { SendPayment, SendPaymentSuccess, SendPaymentError, SendPaymentActionTypes } from '@modules/accounts/actions/send-payment.actions'
import { SendPaymentService } from '@root/modules/accounts/service/send-payment.service';
